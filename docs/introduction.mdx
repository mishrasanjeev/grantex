...
<AccordionGroup>
  ...
  <Accordion title="Who owns the standard?">
    The protocol spec is open (MIT). The goal is to contribute the spec to a neutral standards body (W3C, IETF, or CNCF) once it stabilizes. An [IETF Internet-Draft](/community/ietf-draft) has already been submitted.
  </Accordion>
</AccordionGroup>
