...
description: "Delegated Agent Authorization Protocol (DAAP) — active individual Internet-Draft, revision 01."
---
...
The source is at [`docs/ietf-draft/draft-mishra-oauth-agent-grants-01.md`](https://github.com/mishrasanjeev/grantex/blob/main/docs/ietf-draft/draft-mishra-oauth-agent-grants-01.md).
...
3. Upload `draft-mishra-oauth-agent-grants-01.xml`
