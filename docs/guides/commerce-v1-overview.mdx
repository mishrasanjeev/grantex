...
| Audience | Path |
| --- | --- |
| Product, merchant success, and implementation owners | Read `docs/guides/commerce-v1-agentic-commerce-implementation-prd.md` for the full self-serve merchant gap plan and fast-track roadmap. |
