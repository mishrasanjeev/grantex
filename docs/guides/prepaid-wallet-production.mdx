...
Python `0.5.0` passed source import, Ruff, strict Mypy, Pytest, distribution
...
$PyPI = Invoke-RestMethod 'https://pypi.org/pypi/grantex/0.5.0/json'
if ($PyPI.info.version -ne '0.5.0') { throw 'PyPI verification failed.' }
```
