...
what Grantex Commerce V1 supports for the approved Shopify live pilot, how
internal sandbox and temporary smoke evidence still fit, and which boundaries
remain controlled before broader merchant or provider expansion.
...
- Provider/live-payment/Plural production settlement signoff is missing for the
  claimed provider behavior.
...
- Option A smoke evidence: operator-internal artifact, available to
  authorized reviewers via `sanjeev@orchestrum.in or mishra.sanjeev@gmail.com`.
