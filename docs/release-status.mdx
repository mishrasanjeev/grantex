...
- **Go application:** use `github.com/mishrasanjeev/grantex-go@v0.1.10` with the [agent-ID workaround](/sdks/go/overview#known-v0110-limitations) and [REST/CLI audit-write workaround](/sdks/go/audit#log).
