...
| TypeScript SDK | `@grantex/sdk@0.5.0` | Published to npm and fresh-install verified | Node.js 18+; ESM |
...
<Note>
TypeScript `0.5.0`, x402 `0.3.0`, Python `0.4.0`, and Go `v0.2.0` were
independently registry-verified after publication. Installing any SDK does not provision external
...
- **TypeScript application:** use published `@grantex/sdk@0.5.0` for layered prepaid-wallet governance and OAuth Agent Grants.
- **x402 prepaid-wallet application:** use published `@grantex/x402@0.3.0` with `@grantex/sdk@0.5.0`; keep external custody disabled until an operator adapter passes review.
