...
Published release: **`grantex==0.4.0`**. Source candidate `0.4.1` adds the
audited refresh-recovery and retry behavior described below; do not install it
until [Release Status](/release-status) records PyPI verification.
