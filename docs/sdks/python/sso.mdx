...
title: "SSO (OIDC + SAML)"
sidebarTitle: "SSO"
description: "Enterprise single sign-on with multi-IdP connections, SAML 2.0, OIDC, JIT provisioning, and domain-based enforcement using the Grantex Python SDK."
---
