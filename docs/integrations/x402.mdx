...
supports opt-in Base native USDC EIP-3009. This addition is not included in the
published versions listed above and is not a claim of hosted-service deployment.
