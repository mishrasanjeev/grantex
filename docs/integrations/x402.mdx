...
`@grantex/sdk@0.5.0`, `@grantex/x402@0.3.0`, Python `grantex==0.4.1`, and Go
`v0.2.1`. Python `0.4.1` and Go `v0.2.1` include bounded refresh recovery and
retry hardening. TypeScript `0.5.1` includes the matching changes in source but
remains a release candidate until npm and clean-install verification complete.
