...
`@grantex/sdk@0.6.0`, `@grantex/x402@0.4.0`, Python `grantex==0.5.1`, and Go
`v0.3.0`. All four versions are registry verified. TypeScript `0.6.0`, Python
`0.5.1`, and Go `v0.3.0` include bounded refresh recovery and retry hardening.
...
installs. Published Python `0.5.1` and Go `v0.3.0` include EVM payment responses
