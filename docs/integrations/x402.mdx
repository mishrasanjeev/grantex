...
`@grantex/sdk@0.5.1`, `@grantex/x402@0.3.0`, Python `grantex==0.4.1`, and Go
`v0.2.1`. All four versions are registry verified. TypeScript `0.5.1`, Python
`0.4.1`, and Go `v0.2.1` include bounded refresh recovery and retry hardening.
