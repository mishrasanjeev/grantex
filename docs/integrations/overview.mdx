...
<CardGroup cols={2}>
  ...
  <Card title="x402 Payment Protocol" icon="credit-card" href="/integrations/x402">
    Official x402 v2 with DPoP-bound prepaid reservations, multi-wallet policy,
    rolling limits, reload approval, and principal stop controls.
  </Card>
...
| MCP Auth Server | `@grantex/mcp-auth@2.0.2` | `npm install @grantex/mcp-auth@2.0.2 @grantex/sdk@0.5.0` | TypeScript; evaluation only |
...
| Go SDK | `grantex-go@v0.2.1` | `go get github.com/mishrasanjeev/grantex-go@v0.2.1` | Go 1.26.1+; published and public-proxy verified with wallet governance, corrected Agent/Audit contracts, and bounded refresh recovery |
