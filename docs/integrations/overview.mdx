...
| Go SDK | `grantex-go@v0.2.0` | `go get github.com/mishrasanjeev/grantex-go@v0.2.0` | Go 1.26.1+; wallet governance and corrected Agent/Audit contracts; `v0.2.1` is a source candidate |
