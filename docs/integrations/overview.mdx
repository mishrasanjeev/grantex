...
| Go SDK | `grantex-go@v0.3.0` | `go get github.com/mishrasanjeev/grantex-go@v0.3.0` | Go 1.26.1+; published and public-proxy verified with wallet governance, corrected Agent/Audit contracts, and bounded refresh recovery |
