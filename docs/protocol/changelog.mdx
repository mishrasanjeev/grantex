...
Release snapshot verified: **September 1, 2026**

| Surface | Current release |
|---|---:|
| TypeScript SDK | `@grantex/sdk@0.5.0` |
| x402 Payment Protocol | `@grantex/x402@0.3.0` |
| Python SDK | `grantex==0.4.1` |
| Go SDK | `github.com/mishrasanjeev/grantex-go@v0.2.1` |
| MCP Auth server | `@grantex/mcp-auth@2.0.2` |
| OpenAPI contract | `0.5.0` |
...
Prepared source candidate `@grantex/sdk@0.5.1` remains unpublished until its
npm and clean-install checks complete. Python `0.4.1` and Go `v0.2.1` are
published and verified from clean public-registry installs.

## Canonical sources

<CardGroup cols={2}>
  <Card title="Release Status" icon="box" href="/release-status">
    Published SDKs, prepared candidates, runtime requirements, registry links,
