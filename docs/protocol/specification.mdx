...
*The full specification is maintained at [github.com/mishrasanjeev/grantex/blob/main/SPEC.md](https://github.com/mishrasanjeev/grantex/blob/main/SPEC.md) and is licensed under [MIT](https://github.com/mishrasanjeev/grantex/blob/main/LICENSE).*
