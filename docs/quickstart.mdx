...
This guide installs the current registry-verified TypeScript `0.5.0`, Python
`0.4.0`, Go `v0.2.0` (which requires Go 1.26.1+), and MCP Auth `2.0.2`.
See [Release Status](/release-status) for prepared patch candidates and upgrade guidance.
