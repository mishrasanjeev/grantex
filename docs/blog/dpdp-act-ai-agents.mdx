...
- Your application can expose a withdrawal control backed by the authenticated
  DPDP API or SDK
...
deployment. It applies in phases: current Commission guidance places
transparency rules in August 2026, listed high-risk areas in December 2027, and
product-integrated high-risk systems in August 2028. Depending on your role and
risk classification, relevant supporting controls may include:
...
separate or embeddable DPDP end-user portal.
