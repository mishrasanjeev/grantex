...
<Note>
  **Implementation snapshot, updated July 12, 2026:** these examples target
  `@grantex/langchain@0.1.7`, `@grantex/sdk@0.5.1`, and the repository's
...
```bash
npm install --save-exact @grantex/langchain@0.1.7 @grantex/sdk@0.5.1 @langchain/core@1.2.2
```
...
`@grantex/sdk@0.5.1` exports 53 manifests. Salesforce, HubSpot, Jira, and Stripe are included:
