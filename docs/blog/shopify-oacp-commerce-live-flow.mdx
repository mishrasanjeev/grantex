...
- Grantex C6Z authority called by a platform-admin operator can issue 11
  internal artifact families on the launch-closure branch, all verifier-valid
  and all non-executing.
