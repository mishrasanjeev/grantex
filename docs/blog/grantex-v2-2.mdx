...
The active individual IETF draft (`draft-mishra-oauth-agent-grants-01`) includes Budget Controls, Event Streaming, Credential Vault, and External Policy Backends sections plus an implementation report. We also published a draft NIST NCCoE comment mapping DAAP capabilities to the AI Risk Management Framework; no public submission receipt or NIST endorsement is claimed.
