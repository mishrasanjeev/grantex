...
The Google ADK and LangChain integrations verify tokens through their configured
JWKS endpoint before scope enforcement; they are not automatically network-free.
For a truly disconnected Gemma deployment, use the consent bundle's preloaded
JWKS snapshot and offline audit log shown above.
