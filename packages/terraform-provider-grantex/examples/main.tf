...
# The signing secret is generated by Grantex and exposed as the `secret` attribute.
...
# OIDC SSO configuration with Okta
...
output "webhook_secret" {
  ...
  sensitive   = true
  description = "The server-generated signing secret for the grant events webhook"
}
