export const SCOPE_DESCRIPTIONS: Record<string, string> = {
  ...
  'wallet:read': 'View prepaid wallets assigned to the agent',
  'wallet:spend': 'Authorize payments from assigned prepaid wallets',
  'wallet:reload:request': 'Request a principal-approved prepaid wallet reload',
