...
export type CommerceAuditEventType =
  ...
  | 'connector_dry_run_review_requested'
  | 'connector_dry_run_review_decision_recorded'
  | 'connector_dry_run_review_blocked'
  ...
  | 'merchant_webhook.received'
  | 'merchant_webhook.signature_failed'
  | 'catalog.product.updated'
  | 'provider.webhook.received'
  | 'provider.webhook.signature_failed'
  | 'provider_webhook.replay_requested'
  | 'provider_webhook.replayed'
  | 'provider_webhook.replay_denied'
  | 'payment_intent.paid'
